...
let redFigur = document.getElementById("redFigure");
let yellowFigur = document.getElementById("yellowFigure");

console.log(redFigur);
console.log(yellowFigur);
...
// din kode her
redFigur.style.backgroundColor = "blue";
yellowFigur.style.backgroundColor = "blue";
...
let purpleFigure = document.getElementsByClassName("purpleFigures");
let purpleFiguresArray = Array.from(purpleFigure);
...
purpleFiguresArray.forEach((myElement) => {
...
// Tilføjer elementer til opgaveFourElement
opgaveFourElement.appendChild(nameElement);
opgaveFourElement.appendChild(imageElement);
opgaveFourElement.appendChild(descriptionElement);
